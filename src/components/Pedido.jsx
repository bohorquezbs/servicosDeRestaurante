    ...
    return (
        <>
            <div className="flex flex-col  border-2 border-gray-300 rounded w-[90%] h-[293px]  text-black ">
                <img height={284} width={410} src={imagen} className="object-cover  rounded h-[150px]" alt={descripcion} />
                <div className="mt-4 flex flex-col justify-center ">
                    ...
                    <p className="text-[10px] mt-2 md:text-[12px] text-center px-4 md:mx-8"> {descripcion} </p>
                </div>
                <div className="flex flex-col items-center text-center px-3">
                        ...
                        <div className="flex items-center justify-start gap-4 mt-1">
                          <button onClick={decrement} className=" text-black border border-gray-400  bg-white w-6 rounded-full ">-</button>
                          <span className="text-black">{items}</span>
                          <button onClick={increment} className=" text-black border border-gray-400  bg-white w-6 rounded-full  ">+</button>
                        </div>
                      </div>
                    </div>
        </>
